...
public class RandomUtil {
    ...
    /**
     * 获取由System.currentTimeMillis()+指定长度的随机字符串
     * @params [len]
     * @return java.lang.String
     * @version 1.0
     */
    public static String randomMillisStr(int len){
        long curTimeMillis = System.currentTimeMillis();
        String code = getRandomStr(len);
        return curTimeMillis+code;
    }
    ...
    public static int GenerSMSRandomNum (int size){
